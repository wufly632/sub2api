...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "purchase_price", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "purchase_display_order", Type: field.TypeInt, Default: 0},
	...
	SubscriptionOrdersColumns = []*schema.Column{
		...
		{Name: "payment_url", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "payment_qrcode", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "payment_open_order_id", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "payment_transaction_id", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "payment_plugin", Type: field.TypeString, Nullable: true, Size: 32},
		...
		{Name: "canceled_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "notes", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "group_id", Type: field.TypeInt64},
		{Name: "user_id", Type: field.TypeInt64},
	...
	SubscriptionOrdersTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{SubscriptionOrdersColumns[17]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
			...
			{
				Symbol:     "subscription_orders_user_subscriptions_orders",
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{SubscriptionOrdersColumns[10]},
			},
			{
				Name:    "subscriptionorder_created_at",
				Unique:  false,
...
func init() {
	...
	SubscriptionOrdersTable.ForeignKeys[2].RefTable = UserSubscriptionsTable
