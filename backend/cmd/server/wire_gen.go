...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	xunhuPayClient := service.NewXunhuPayClient()
	subscriptionOrderService := service.NewSubscriptionOrderService(client, groupRepository, subscriptionOrderRepository, subscriptionService, settingService, xunhuPayClient)
	purchaseHandler := handler.NewPurchaseHandler(subscriptionOrderService)
	paymentHandler := handler.NewPaymentHandler(subscriptionOrderService)
	...
	orderHandler := admin.NewOrderHandler(subscriptionOrderService)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, orderHandler)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, purchaseHandler, paymentHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler)
	...
	subscriptionOrderExpiryService := service.ProvideSubscriptionOrderExpiryService(client)
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, schedulerSnapshotService, tokenRefreshService, accountExpiryService, subscriptionExpiryService, subscriptionOrderExpiryService, usageCleanupService, pricingService, emailQueueService, billingCacheService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService)
