export default {
  ...
  purchase: {
    ...
    paymentUnavailable: '支付链接未返回，请联系管理员。',
    paymentSuccess: '支付成功，订阅已开通。',
    paymentCanceled: '订单已取消或关闭。',
    qrExpiredRefreshing: '二维码已过期，正在刷新...',
    qrRefreshed: '已生成新的支付二维码。',
    qrRefreshFailed: '二维码刷新失败，请重新下单或联系管理员。',
    dailyLimit: '日限额',
    weeklyLimit: '周限额',
    monthlyLimit: '月限额',
    unlimited: '无限制',
