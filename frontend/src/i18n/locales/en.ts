export default {
  ...
  purchase: {
    ...
    paymentUnavailable: 'Payment info not available. Please contact admin.',
    paymentSuccess: 'Payment successful. Subscription is now active.',
    paymentCanceled: 'Order has been canceled or closed.',
    qrExpiredRefreshing: 'QR code expired. Refreshing...',
    qrRefreshed: 'New payment QR code generated.',
    qrRefreshFailed: 'Failed to refresh QR code. Please place a new order or contact admin.',
    ...
    viewQr: 'View QR Code',
    qrTitle: 'Scan to Pay',
    qrCountdown: 'QR code expires in',
    qrTip: 'Scan with WeChat or Alipay to complete payment. Subscription activates after payment.',
    qrUnavailable: 'QR code not available. Click “Open Payment Page” to continue.',
